...
img2=cv2.imread('jota3.png',0)
img3=cv2.imread('jota5.png',0)
kernel=np.ones((5,5),np.uint8)
resd = dilation(img,kernel) 
rese = erosion(img, kernel)
reso=opening(img2, kernel)
resc=closing(img3, kernel)
cv2.imshow('res1',resd)
cv2.imshow('res2',rese)
cv2.imshow('res3',reso)
cv2.imshow('res4',resc)
